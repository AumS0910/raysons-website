...
//  Runs on every .fheat canvas (the hero AND the furnace beat), each idle-gated
//  (IntersectionObserver + tab visibility) and reduced-motion safe on its own.
// ============================================================
(function(){
  ...
  document.querySelectorAll('.fheat').forEach(initHeat);
})();
