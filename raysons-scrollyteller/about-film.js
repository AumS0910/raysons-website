...
(function(){
  ...
  // autoplay the casting clip (muted, looping, inline) on EVERY device — the user wants the
  // film to play on phone too, not just show the poster. iOS allows muted + playsinline
  ...
  function loop(){
    ...
    cur += (target - cur) * (REDUCED ? 1 : damp(7.7, _dt));
    render(cur);
